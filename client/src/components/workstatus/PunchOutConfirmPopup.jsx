...
const PunchOutConfirmPopup = ({ onCancel, onConfirm }) => {
  return (
    ...
    >
      <div className="bg-[#232945] rounded-lg shadow-lg p-6 max-w-md w-full">
        ...
        <div className="flex justify-end space-x-3">
          <button
            onClick={onCancel}
            className="px-4 py-2 rounded bg-black-300 hover:bg-gray-400"
          >
            Cancel
          </button>
          <button
            onClick={onConfirm}
            className="px-4 py-2 rounded bg-red-600 text-black hover:bg-red-500"
          >
            Punch Out Anyway
          </button>
        </div>
