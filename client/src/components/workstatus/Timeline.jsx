...
const getEventIcon = (type) => {
  ...
  if (eventType.includes("punch out")) {
    return (
      <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
        <path fillRule="evenodd" d="M10 18a8 8 0 100-16 8 8 0 000 16zm3.707-10.293a1 1 0 00-1.414-1.414L9 9.586 6.707 7.293a1 1 0 00-1.414 1.414L8.586 12l-3.293 3.293a1 1 0 001.414 1.414L10 13.414l3.293 3.293a1 1 0 001.414-1.414L11.414 12l3.293-3.293z" clipRule="evenodd" />
      </svg>
    );
  }
          ...
          {sortedTimeline.map((item, index) => (
            ...
            >
              <div className="flex items-center space-x-4">
                <div className={`w-10 h-10 bg-gradient-to-r ${getEventTypeColor(item.type)} rounded-lg flex items-center justify-center text-white shadow-lg`}>
              ...
              <div className="text-right">
                ...
                <div className={`w-3 h-3 bg-gradient-to-r ${getEventTypeColor(item.type)} rounded-full ml-auto mt-1 shadow-sm`}></div>
              </div>
            </div>
          ))}
        </div>
