    ...
    <div className="flex-1 flex flex-col overflow-hidden">
      ...
      <div className="bg-[#202c33] border-b border-[#2a3942] px-4 py-3 flex justify-center">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 bg-[#00a884] hover:bg-[#128C7E] text-white rounded-lg transition-all font-medium shadow-lg disabled:opacity-50 disabled:cursor-not-allowed"
        >
          {downloading ? (
            <>
