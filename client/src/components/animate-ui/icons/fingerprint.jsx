...
import { getVariants, useAnimateIconContext, IconWrapper, pathClassName } from '@/components/animate-ui/icons/icon';
...
export { animations, Fingerprint, Fingerprint as FingerprintIcon };
