...
function ChartNoAxesColumnDecreasing(props) {
  return <IconWrapper icon={IconComponent} {...props} />;
}

export { animations, ChartNoAxesColumnDecreasing, ChartNoAxesColumnDecreasing as ChartNoAxesColumnDecreasingIcon };
