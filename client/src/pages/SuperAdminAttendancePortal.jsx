          ...
          <div className="bg-gradient-to-br from-slate-800/50 to-slate-900/50 backdrop-blur-sm border border-slate-600/30 rounded-2xl p-6 hover:border-cyan-400/40 transition-all duration-300">
            ...
            <div className="space-y-6">
              ...
              <div className="employee-selector relative">
                ...
                {/* Dropdown for search results - Fixed z-index and positioning */}
                {showDropdown && (searchTerm.trim() || filteredEmployees.length > 0) && (
                  <div 
                    className="absolute w-full bg-slate-800/95 backdrop-blur-xl border border-slate-600/50 rounded-xl shadow-2xl max-h-72 overflow-y-auto mt-2"
                    style={{
                      zIndex: 50
                    }}
                  >
