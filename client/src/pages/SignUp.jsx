        ...
        <form onSubmit={handleSubmit} className="space-y-5" noValidate>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="date" name="dob" value={form.dob} max={todayISO} onChange={handleChange} className="w-full px-4 py-2 border border-border rounded-md" required />
            </div>
            <div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            ...
            <div>
              ...
              <select name="jobLevel" value={form.jobLevel} onChange={handleChange} className="w-full px-4 py-2 border border-border rounded-md">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <input type="date" name="doj" value={form.doj} max={todayISO} onChange={handleChange} className="w-full px-4 py-2 border border-border rounded-md" required />
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              <input type="text" name="skills" value={skillsInput} onChange={(e) => setSkillsInput(e.target.value)} placeholder="e.g. JavaScript, React, Node.js" className="w-full px-4 py-2 border border-border rounded-md" />
            </div>
          </div>
          ...
          <div>
            ...
            <select name="shiftType" value={form.shiftType} onChange={handleChange} className="w-full px-4 py-2 border border-border rounded-md">
          ...
          <div className="space-y-4">
              ...
              <div key={index} className="border border-border rounded-lg p-4 bg-backgroundAlt space-y-3 relative">
                <div className="flex justify-between items-center mb-2">
                  ...
                  {form.qualifications.length > 1 && (
                    <button type="button" onClick={() => removeQualification(index)} className="text-red-500 hover:underline text-sm">Remove</button>
                  )}
                </div>
            ...
            <button type="button" onClick={addQualification} className="text-primary underline text-sm">+ Add Qualification</button>
          </div>
